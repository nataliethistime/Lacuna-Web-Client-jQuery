	...
	function Building() {
		this.view = function(building) {
			...
			Lacuna.send({
				...
				success: function(o) {
					...
					var extraTabs = this.buildings[building.type] ? 
						this.buildings[building.type].getTabs() : [];
		...
		this.getViewTab = function(o) {
			return [
				...
				'			<span class="building-details-num">', Library.formatNum(o.food_hour), '/hr</span>',
				'		</li>',
				'		<li>',
				'			<span class="small-img"><img src="', window.assetsUrl, '/ui/s/ore.png" /></span>',
				'			<span class="building-details-num">', Library.formatNum(o.ore_hour), '/hr</span>',
				'		</li>',
				'		<li>',
				'			<span class="small-img"><img src="', window.assetsUrl, '/ui/s/water.png" /></span>',
				'			<span class="building-details-num">', Library.formatNum(o.water_hour), '/hr</span>',
				'		</li>',
				'		<li>',
				'			<span class="small-img"><img src="', window.assetsUrl, '/ui/s/energy.png" /></span>',
				'			<span class="building-details-num">', Library.formatNum(o.energy_hour), '/hr</span>',
				'		</li>',
				'		<li>',
				'			<span class="small-img"><img src="', window.assetsUrl, '/ui/s/waste.png" /></span>',
				'			<span class="building-details-num">', Library.formatNum(o.waste_hour), '/hr</span>',
				'		</li>',
				'		<li>',
				'			<span class="small-img"><img src="', window.assetsUrl, '/ui/s/happiness.png" /></span>',
				'			<span class="building-details-num">', Library.formatNum(o.happiness_hour), '/hr</span>',
				'		</li>',
				'		<li>' +
				...
				'			<span class="building-details-num',
								...
								Library.formatNum(o.upgrade.cost.waste || 0), '/hr</span>',
				'		</li>',
				'		<li>',
				'			<span class="small-img"><img src="', window.assetsUrl, '/ui/s/time.png" /></span>',
				'			<span class="building-details-num">', Library.formatTime(o.upgrade.cost.time || 15), '</span>',
				'		</li>',
				o.upgrade.can ?
				'		<li>' +
